        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
          ...
          >
            ...
            <p className="text-lg md:text-xl text-gray-600 dark:text-gray-400 mb-8 max-w-2xl mx-auto lg:mx-0">
              Sono un ragazzo di 20 anni, solare e intraprendente, con una grande passione per il mondo del web e del design.
              <br/> Mi piace mettermi in gioco, imparare nuove tecnologie e lavorare su progetti creativi. 
              <br/> Nel tempo libero mi dedico alla palestra, sempre con lo stesso impegno e determinazione che applico anche nello sviluppo e nella progettazione. 🚀

              <br/> Offro servizi di Disegno, prototipazione e creazione di siti web interattivi e responsive, per aziende e professionisti.

              <br/> Sono specializzato in HTML, CSS, JavaScript e Bootstrap per portare idee alla vita sul web. Lavoriamo insieme e creiamo qualcosa di straordinario!
            </p>
          ...
          >
            <div className="relative w-72 h-72 md:w-96 md:h-96 mx-auto">
              ...
              <div className="relative rounded-2xl overflow-hidden shadow-2xl relative w-72 h-72 md:w-96 md:h-96">
                <Image
                  src="https://upload.wikimedia.org/wikipedia/commons/thumb/9/9e/Ginger_european_cat.jpg/220px-Ginger_european_cat.jpg"
                  alt="Usman Zafar"
                  fill
