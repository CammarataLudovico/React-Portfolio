...
import { MailPlus, MapPin, Phone, Send, Loader2 } from "lucide-react"
...
const formSchema = z.object({
  ...
  email: z.string().email("Per favore utilizza un indirizzo email valido"),
  subject: z.string().min(5, "L'oggetto dell'email deve avere almeno 5 caratteri!"),
        ...
        <div className="flex flex-col lg:flex-row gap-12">
          ...
          >
            <div className="bg-white dark:bg-gray-800 p-8 rounded-xl shadow-lg">
              <h3 className="text-2xl font-semibold mb-6 dark:text-white">Contatti</h3>
              <div className="space-y-6">
                ...
                >
                  <MailPlus className="w-8 h-8 mr-3 text-blue-600" />
                  cammarataludvico9@gmail.com 
                </a>
                <a
                  href="tel:+1234567890"
                  className="flex items-center text-gray-600 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 transition-colors duration-300"
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="bg-white dark:bg-gray-800 p-8 rounded-xl shadow-lg">
              ...
              <div className="mt-6">
                ...
                >
                  ...
                  {isSubmitting ? "Sto inviando il messaggio" : "Invia messaggio"}
                </button>
              </div>
              {submitSuccess && (
